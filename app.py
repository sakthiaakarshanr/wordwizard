...
# Load models
try:
    aif_model = load_model(r"new_models/AIF/jl/aif_rf_model.pkl")
    aif_scaler = load_model(r"new_models/AIF/jl/aif_rf_scaler.pkl")
    aif_label_enc = load_model(r"new_models/AIF/jl/aif_rf_le.pkl")
